...
const GLfloat CameraRendererRGB565GL2::mLandscapeVertices[] = { -1.0f, 1.0f,
		0.0f, // Position 0
...
const GLfloat CameraRendererRGB565GL2::mLandscapeReverseVertices[] = { 1.0f,
...
const GLfloat CameraRendererRGB565GL2::mPortraitVertices[] = { 1.0f, 1.0f, 0.0f, // Position 0
		0.0f, 0.0f, // TexCoord 0
		-1.0f, 1.0f, 0.0f, // Position 1
		0.0f, 1.0f, // TexCoord 1
		1.0f, -1.0f, 0.0f, // Position 2
...
const GLfloat CameraRendererRGB565GL2::mPortraitReverseVertices[] = { -1.0f,
		-1.0f, 0.0f, // Position 0
		0.0f, 0.0f, // TexCoord 0
		1.0f, -1.0f, 0.0f, // Position 1
		0.0f, 1.0f, // TexCoord 1
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
bool CameraRendererRGB565GL2::Render(const uint8_t* img, uint16_t w,
		uint16_t h) {
...
bool CameraRendererRGB565GL2::CreateShaderProgram() {
	...
	const char* vShaderStr = "precision highp float;           \n"
	...
	const char* fShaderStr = "precision highp     float;				                 \n"
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
bool CameraRendererRGB565GL2::UpdateTextures(const uint8_t* rgbImg, uint16_t w,
		uint16_t h) {
	glActiveTexture( GL_TEXTURE0);
	glBindTexture( GL_TEXTURE_2D, mTextureId[0]);
	if (CameraUtil::checkGlError("glBindTexture-RGB"))
