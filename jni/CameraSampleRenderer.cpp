...
#define LOG_TAG    "CameraSampleRenderer.cpp"
...
JNIEXPORT void JNICALL 
   Java_com_example_cameranative_CameraSampleRenderer_cleanup
(
   JNIEnv * env, 
   jobject obj
)
...
//------------------------------------------------------------------------------
JNIEXPORT void JNICALL 
   Java_com_example_cameranative_CameraSampleRenderer_surfaceChanged
(
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
JNIEXPORT jfloat JNICALL Java_com_example_cameranative_CameraSampleRenderer_getGPUFPS
(
   JNIEnv*  env, 
   jobject  obj
)
